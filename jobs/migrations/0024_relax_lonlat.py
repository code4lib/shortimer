...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('jobs_location', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Location.longitude'
        db.alter_column('jobs_location', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Location.latitude'
        db.alter_column('jobs_location', 'latitude', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'Location.longitude'
        db.alter_column('jobs_location', 'longitude', self.gf('django.db.models.fields.FloatField')(default=None))
