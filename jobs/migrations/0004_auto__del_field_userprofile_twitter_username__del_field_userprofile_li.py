...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('jobs_userprofile', 'twitter_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'UserProfile.facebook_id'
        db.add_column('jobs_userprofile', 'facebook_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'UserProfile.linkedin_id'
        db.add_column('jobs_userprofile', 'linkedin_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'UserProfile.github_id'
        db.add_column('jobs_userprofile', 'github_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('jobs_userprofile', 'twitter_id')

        # Deleting field 'UserProfile.facebook_id'
        db.delete_column('jobs_userprofile', 'facebook_id')

        # Deleting field 'UserProfile.linkedin_id'
        db.delete_column('jobs_userprofile', 'linkedin_id')

        # Deleting field 'UserProfile.github_id'
        db.delete_column('jobs_userprofile', 'github_id')
