...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Employer.slug'
        db.add_column('jobs_employer', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Employer.slug'
        db.delete_column('jobs_employer', 'slug')
