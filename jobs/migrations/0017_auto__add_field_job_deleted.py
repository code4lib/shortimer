...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.deleted'
        db.add_column('jobs_job', 'deleted', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.deleted'
        db.delete_column('jobs_job', 'deleted')
