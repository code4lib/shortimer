...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Employer.freebase_id'
        db.add_column('jobs_employer', 'freebase_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Employer.freebase_id'
        db.delete_column('jobs_employer', 'freebase_id')
