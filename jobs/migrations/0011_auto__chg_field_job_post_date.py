...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.post_date'
        db.alter_column('jobs_job', 'post_date', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Job.post_date'
        raise RuntimeError("Cannot reverse this migration. 'Job.post_date' and its values cannot be restored.")
