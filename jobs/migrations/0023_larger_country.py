...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Employer.country'
        db.alter_column('jobs_employer', 'country', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Employer.country'
        db.alter_column('jobs_employer', 'country', self.gf('django.db.models.fields.CharField')(max_length=2))
