...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'JobEdit'
        db.create_table('jobs_jobedit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='edits', to=orm['auth.User'])),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(related_name='edits', to=orm['jobs.Job'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('jobs', ['JobEdit'])

        # Deleting field 'Job.description_scrubbed'
        db.delete_column('jobs_job', 'description_scrubbed')


    def backwards(self, orm):
        
        # Deleting model 'JobEdit'
        db.delete_table('jobs_jobedit')

        # Adding field 'Job.description_scrubbed'
        db.add_column('jobs_job', 'description_scrubbed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
