...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.updated'
        db.alter_column('jobs_job', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 1, 26, 4, 33, 6, 201320)))


    def backwards(self, orm):
        
        # Changing field 'Job.updated'
        db.alter_column('jobs_job', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
