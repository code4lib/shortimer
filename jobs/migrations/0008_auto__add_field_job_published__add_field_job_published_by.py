...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.published'
        db.add_column('jobs_job', 'published', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Job.published_by'
        db.add_column('jobs_job', 'published_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='published_jobs', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.published'
        db.delete_column('jobs_job', 'published')

        # Deleting field 'Job.published_by'
        db.delete_column('jobs_job', 'published_by_id')
